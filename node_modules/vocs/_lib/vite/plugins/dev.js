            ...
            return () => {
                server.middlewares.use(async (req, res, next) => {
                    ...
                    try {
                        ...
                        const template = await server.transformIndexHtml(url, indexHtml.replace(/\.\.\/app/g, `/@fs${resolve(__dirname, '../../app')}`));
                        const module = await server.ssrLoadModule(resolve(__dirname, '../../app/index.server.js'));
