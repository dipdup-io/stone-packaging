...
const getVarName = (scope) => (_, path) => `vocs-${scope}_${path.join('-')}`;
...
globalStyle('.twoslash-hover:hover .twoslash-popup-info, .twoslash-query-persisted .twoslash-popup-info', {
    opacity: 1,
    pointerEvents: 'auto',
});
...
globalStyle('.twoslash-completion-list .twoslash-completion-list-item span.twoslash-completions-unmatched.twoslash-completions-unmatched.twoslash-completions-unmatched', {
...
globalStyle('.twoslash-completion-list .twoslash-completion-list-item span.twoslash-completions-matched.twoslash-completions-unmatched.twoslash-completions-unmatched', {
...
//# sourceMappingURL=twoslash.css.js.map