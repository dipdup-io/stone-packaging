...
import { borderRadiusVars, fontSizeVars, lineHeightVars, primitiveColorVars, semanticColorVars, spaceVars, viewportVars, } from '../../styles/vars.css.js';
...
globalStyle(`${root} .has-focused > code > .line:not(.focused), ${root} .has-focused > code > .twoslash-meta-line:not(.focused)`, {
    opacity: '0.3',
    transition: 'opacity 0.2s',
});
globalStyle(`${root}:hover .has-focused .line:not(.focused), ${root}:hover .has-focused .twoslash-meta-line:not(.focused)`, {
    opacity: '1',
    transition: 'opacity 0.2s',
});
...
//# sourceMappingURL=CodeBlock.css.js.map