...
import { borderRadiusVars, contentVars, primitiveColorVars, sidebarVars, spaceVars, topNavVars, viewportVars, } from '../styles/vars.css.js';
...
export const section = style({ alignItems: 'center', display: 'flex', height: '100%', gap: spaceVars[24] }, 'section');
//# sourceMappingURL=DesktopTopNav.css.js.map