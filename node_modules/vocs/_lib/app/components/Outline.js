...
export function Outline({ minLevel = 2, maxLevel: maxLevel_ = 3, highlightActive = true, onClickItem, showTitle = true, } = {}) {
    ...
    return (_jsxs("aside", { className: styles.root, children: [_jsxs("nav", { className: styles.nav, children: [showTitle && _jsx("h2", { className: styles.heading, children: "On this page" }), _jsx(Items, { activeId: highlightActive ? activeId : null, items: items, onClickItem: () => {
                            onClickItem?.();
